...
static int counterCCW;
static int counterCCW_p;
...
void MotorControlWithRegulation()
{
  ...
  else if (omegaRefForward > ZERO && omegaRefLeft > 15) // lewo + przod
  {
    ...
    m1TurnTemp = ((omegaRefForward + omegaRefLeft) / 2);             //PWM silnik prawy
    m2TurnTemp = ((omegaRefForward + omegaRefLeft) / 2) - turnConst;  //PWM silnik lewy
